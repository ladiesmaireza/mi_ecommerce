...
const initDb = async () => {
    try {
        ...
        console.log("Tabel produk disinkronkan dengan database");
    } catch (error) {
        console.error("Kesalahan saat membuat tabel database:", error);
    }
};
...
app.post('/products', async (req, res) => {
    try {
        ...
        if (!name || !price) {
            return errorResponse(res, 400, 'Nama dan harga harus diisi');
        }
